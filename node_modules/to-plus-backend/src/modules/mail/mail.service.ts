...
export class MailService {
    ...
    constructor() {
        if (process.env.SMTP_HOST) {
            ...
            this.logger.log(`SMTP configured: ${process.env.SMTP_HOST}:${port} (secure: ${secure})`);
        }
    }
    ...
    async sendPasswordResetEmail(email: string, token: string) {
        ...
        const resetLink = `http://localhost:3001/#/reset-password?token=${token}`; // TODO: Use env var for frontend URL
        ...
        <body>
            <div class="container">
                <div class="header">
                    <a href="#" class="logo">To<span>ERP</span> Bulut</a>
                </div>
                <div class="content">
                    <h1 class="h1">Şifre Sıfırlama İsteği</h1>
                    <p class="text">Merhaba,</p>
                    <p class="text">To ERP Bulut hesabınız için bir şifre sıfırlama talebi aldık. Şifrenizi yenilemek için aşağıdaki butona tıklayabilirsiniz:</p>
                ...
                <div class="footer">
                    &copy; ${new Date().getFullYear()} To ERP Bulut - Dijital İş Zekası. Tüm hakları saklıdır.<br>
        ...
        const mailOptions = {
            from: `"To ERP Bulut Destek" <${process.env.MAIL_FROM || 'no-reply@tobulut.com'}>`,
            to: email,
            subject: "To ERP Bulut Hesabınız İçin Şifre Sıfırlama",
            html: htmlContent,
        };
